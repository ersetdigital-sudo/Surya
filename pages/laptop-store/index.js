    ...
    >
      ...
      <section className="pb-24">
        <div className="tile tile-static p-6 sm:p-8 md:p-12 text-center">
          <h2 className="text-2xl sm:text-3xl md:text-5xl font-bold">Mau sistem POS<br/>untuk bisnis kamu?</h2>
          <div className="mt-8 flex flex-col sm:flex-row sm:flex-wrap justify-center gap-3">
            ...
            <a href="/erlangga-rental" className="inline-flex w-full sm:w-auto items-center justify-center text-center px-6 sm:px-7 py-3.5 sm:py-4 rounded-full text-sm border border-white/12 hover:bg-white/5 transition">Lihat case study Erlangga Rental →</a>
          </div>
        </div>
      </section>
    </CaseShell>
