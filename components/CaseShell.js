...
export default function CaseShell({ title, description, children }) {
  return (
    <>
      ...
      <header className="site-head">
        <div className="mx-auto max-w-[1100px] px-4 sm:px-5 pt-4">
          <div className="glass rounded-[26px] md:rounded-full h-14 px-4 sm:px-5 flex items-center justify-between gap-3">
            <Link
              href="/#work"
              className="text-[13px] text-[#a1a1aa] hover:text-white transition whitespace-nowrap shrink-0"
            >
              ←<span className="hidden sm:inline"> Semua project</span>
            ...
            <div className="ml-auto flex items-center gap-2">
              ...
              <a href="https://wa.me/6285603324143" className="nav-btn nav-btn--primary">
                Hire me
              </a>
            </div>
          </div>
      ...
      <main className="mx-auto max-w-[1100px] px-4 sm:px-5">{children}</main>
